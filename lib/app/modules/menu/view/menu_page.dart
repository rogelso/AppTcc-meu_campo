...
import 'package:meu_campo/app/models/menu_item_model.dart';
          ...
          return ListTile(
            ...
            trailing: Consumer<ShoppingCardController>(
              builder: (_, controllerShoppingCard, __) {
                final itemSelected = controllerShoppingCard.itemSelected(mi);
                ...
                return IconButton(
                  ...
                  onPressed: () => controllerShoppingCard.addOrRemoveItem(mi),
                );
              },
            ),
          );
